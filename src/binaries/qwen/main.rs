...
fn main() -> Result<()> {
    ...
    // --tokenizer_file /Volumes/extdesk/extdev/llm/Qwen2-0.5B/tokenizer.json
    let tokenizer_filename = match args.tokenizer_file {
        Some(file) => std::path::PathBuf::from(file),
        None => repo.get("tokenizer.json")?,
    };
    // --weight_files /Volumes/extdesk/extdev/llm/Qwen2-0.5B/model.safetensors
    ...
    let config_file = std::path::PathBuf::from("/Volumes/extdesk/extdev/llm/Qwen2-0.5B/config.json");
